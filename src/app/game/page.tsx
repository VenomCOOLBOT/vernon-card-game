      ...
      {gameWon ? (
        ...
        <div className="grid lg:grid-cols-4 grid-cols-3 gap-4">
          {cards.map((card) => (
            <div
              key={card.id}
              className={`lg:w-32 lg:h-32 w-16 h-16  flex justify-center items-center lg:text-xl text-xs font-bold border-2 border-foreground rounded-lg cursor-pointer ${
